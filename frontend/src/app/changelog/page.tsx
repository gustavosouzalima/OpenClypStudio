...
export const metadata: Metadata = {
	title: "Changelog - OpenClyp Studio",
	description: "What's new in OpenClyp Studio and the upstream OpenCut editor",
	openGraph: {
		title: "Changelog - OpenClyp Studio",
...
export default function ChangelogPage() {
	...
	return (
		<BasePage title="Changelog" description="See what's new in OpenClyp Studio and the upstream editor">
