...
export function SectionHeader({
	...
	return (
		...
		<div
			...
			tabIndex={0}
			className={cn(
				"flex h-11 w-full cursor-pointer items-center gap-2 px-3.5 hover:bg-accent transition-colors duration-180 ease",
				className,
			)}
			onClick={handleClick}
	...
	if (onClick) {
		return (
			<button
				type="button"
				className={cn(
					"cursor-pointer text-sm font-medium transition-colors duration-180 ease",
