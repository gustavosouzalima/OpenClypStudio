...
function ContentSection({
  ...
  return (
    <Section
      collapsible
      sectionKey={`${element.type}:content:${element.id}`}
      showTopBorder={false}
    >
      <SectionHeader>
...
function TypographySection({
  ...
  return (
    <Section
      collapsible
      sectionKey={`${element.type}:typography:${element.id}`}
    >
      <SectionHeader>
        ...
        <SectionFields>
          ...
          <SectionField label="Style">
            <div className="flex gap-1">
              <Button
                variant={
                  element.fontWeight === "bold" ? "secondary" : "outline"
                }
                size="sm"
              ...
              <Button
                variant={
                  element.fontStyle === "italic" ? "secondary" : "outline"
                }
                size="sm"
              ...
              <Button
                ...
                size="sm"
                className="h-7 flex-1 text-xs underline"
                onClick={() =>
                  editor.timeline.updateElements({
                    updates: [
                      {
              ...
              <Button
                ...
                size="sm"
                className="h-7 flex-1 text-xs line-through"
                onClick={() =>
                  editor.timeline.updateElements({
                    updates: [
                      {
            ...
            <div className="flex gap-1">
              {(["left", "center", "right"] as const).map((align) => (
                <Button
                  key={align}
                  variant={
                    element.textAlign === align ? "secondary" : "outline"
                  }
                  size="sm"
...
function SpacingSection({
  ...
  return (
    <Section
      collapsible
      sectionKey={`${element.type}:spacing:${element.id}`}
...
function BackgroundSection({
  ...
  return (
    <Section
      ...
      sectionKey={`${element.type}:background:${element.id}`}
    >
      <SectionHeader
        trailing={
          <Button
