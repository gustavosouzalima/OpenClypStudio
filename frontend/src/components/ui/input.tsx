...
import { inputStates } from "@/design-system";

const inputVariants = cva(
	"file:text-foreground placeholder:text-muted-foreground border-border bg-input flex w-full min-w-0 rounded-md border shadow-xs outline-none file:inline-flex file:border-0 file:bg-transparent file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 focus-visible:ring-0 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-colors",
	{
		variants: {
			variant: {
				...
				"editor-default":
					"bg-[#202734] border-[rgba(255,255,255,0.06)] text-[#f3f6fb] focus-visible:border-[#00cfe8] focus-visible:ring-[rgba(0,207,232,0.22)] hover:border-[rgba(255,255,255,0.12)]",
				"editor-invalid":
					"bg-[#202734] border-[#ef4444] text-[#f3f6fb] focus-visible:ring-[rgba(239,68,68,0.22)]",
			},
			size: {
