...
import { ADD_AUDIO, EDIT_OBJECT, LAYER_CLONE } from "@designcombo/state";
...
const BasicVideo = ({
  ...
  const handleExtractAudio = () => {
    dispatch(ADD_AUDIO, {
      payload: {
        id: generateId(),
        type: "audio",
        name: `${trackItem.name || "Video"} audio`,
        details: {
        ...
        metadata: {
          ...(trackItem.metadata || {}),
          extractedFromVideoId: trackItem.id
        }
      },
      options: {}
    });
  ...
  const components = [
      ...
      component: (
        <div className="flex flex-col gap-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <Button variant="secondary" onClick={handleExtractAudio}>
              Extract Audio
            </Button>
          </div>
        </div>
    ...
    },
    {
      ...
      component: (
        <div className="flex flex-col gap-2">
          <Label className="font-sans text-xs font-semibold">Audio</Label>
          <div className="mb-2">
            <Button variant={"secondary"} onClick={handleExtractAudio}>
              Extract Audio to New Track
            </Button>
          </div>
        </div>
      )
