  ...
  return (
    ...
    >
      ...
      <AutoScrollSync
        ...
        horizontalScrollbarVpRef={horizontalScrollbarVpRef}
...
const AutoScrollSync = ({
  canvasElRef,
  horizontalScrollbarVpRef,
  scrollLeft
}: {
  canvasElRef: React.RefObject<HTMLCanvasElement | null>;
  horizontalScrollbarVpRef: React.RefObject<HTMLDivElement | null>;
  scrollLeft: number;
}) => {
  ...
  }, [canvasElRef, currentFrame, fps, horizontalScrollbarVpRef, scale.zoom, scrollLeft]);
